...
fname = 'areacello_Ofx_MRI-ESM2-0_historical_r1i1p1f1_gn.nc';
fout  = [mdl_name,'_sections.mat'];
ncdisp([dname,fname]);
dmask = '/media/swang/CMIP6_5/MRI-ESM2-0/';
fmask = 'so_Omon_MRI-ESM2-0_ssp585_r1i1p1f1_gn_206501-210012_2100.nc';
ncdisp([dmask,fmask]);
...
nlon  = ncread([dname,fname],'x');
nlat  = ncread([dname,fname],'y');
