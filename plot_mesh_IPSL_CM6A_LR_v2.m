%%
mdl_name = 'IPSL-CM6A-LR';
dname = '/home/swang/Data/grid_and_mask/areacello_cmip6/';
fname = 'areacello_Ofx_IPSL-CM6A-LR_historical_r1i1p1f1_gn.nc';
fout  = [mdl_name,'_sections.mat'];
% ncdisp([dname,fname]);
dmask = '/media/swang/CMIP6_5/IPSL-CM6A-LR/';
fmask = 'so_Omon_IPSL-CM6A-LR_ssp585_r1i1p1f1_gn_201501-210012_2100.nc';
% ncdisp([dmask,fmask]);
...
lon  = ncread([dname,fname],'nav_lon');
lat  = ncread([dname,fname],'nav_lat');
lat_bnds = ncread([dname,fname],'bounds_nav_lat');
lon_bnds = ncread([dname,fname],'bounds_nav_lon');
...
figure;
m_proj('Azimuthal Equal-area','lon',0,'lat',90,'radius',45);
