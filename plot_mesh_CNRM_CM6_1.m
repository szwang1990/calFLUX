...
fname = 'areacello_Ofx_CNRM-CM6-1_historical_r1i1p1f2_gn.nc';
fout  = [mdl_name,'_sections.mat'];
ncdisp([dname,fname]);
dmask = '/media/swang/CMIP6_2/CNRM-CM6-1/';
fmask = 'so_Omon_CNRM-CM6-1_ssp585_r1i1p1f2_gn_206501-210012_2100.nc';
ncdisp([dmask,fmask]);
