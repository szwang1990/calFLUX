...
fname = 'areacello_Ofx_ACCESS-ESM1-5_historical_r1i1p1f1_gn.nc';
...
mdl_name = 'ACCESS-ESM1-5';
dir_mdl = [dir_root,mdl_name,'/'];

fsec = '~/Data/grid_and_mask/areacello_cmip6/ACCESS-ESM1-5_sections.mat';
load(fsec);
mdl_name = 'ACCESS-ESM1-5';% in fsec, the mdl_name is ACCESS-CM2
