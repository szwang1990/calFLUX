% The original mesh infomation provided by NESM3 is wrong.
% I suppose NESM3 employed the same grid with EC-Earth3.
...
fsec = '~/Data/grid_and_mask/areacello_cmip6/EC-Earth3_sections.mat';
load(fsec);
