%%
mdl_name = 'CAMS-CSM1-0';
dname = '/home/swang/Data/grid_and_mask/areacello_cmip6/';
fname = 'areacello_Ofx_CAMS-CSM1-0_1pctCO2_r2i1p1f1_gn.nc';
fout  = [mdl_name,'_sections.mat'];
ncdisp([dname,fname]);
dmask = '/media/swang/CMIP6_1/CAMS-CSM1-0/';
fmask = 'so_Omon_CAMS-CSM1-0_ssp585_r1i1p1f1_gn_208301-209912_2100.nc';
ncdisp([dmask,fmask]);
