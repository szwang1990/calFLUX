...
fname = 'areacello_Ofx_FGOALS-g3_historical_r1i1p1f1_gn.nc';
fout  = [mdl_name,'_sections.mat'];
ncdisp([dname,fname]);
dmask = '/media/swang/CMIP6_2/FGOALS-g3/';
fmask = 'so_Omon_FGOALS-g3_ssp585_r1i1p1f1_gn_206501-210012_2100.nc';
ncdisp([dmask,fmask]);
