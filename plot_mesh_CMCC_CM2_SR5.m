...
ncdisp([dname,fname]);
dmask = '/media/swang/CMIP6_2/CMCC-CM2-SR5/';
fmask = 'so_Omon_CMCC-CM2-SR5_ssp585_r1i1p1f1_gn_209501-210012_2100.nc';
ncdisp([dmask,fmask]);
...
figure;
m_proj('Azimuthal Equal-area','lon',0,'lat',90,'radius',80);
