%%
mdl_name = 'BCC-CSM2-MR';
dname = '/home/swang/Data/grid_and_mask/areacello_cmip6/';
fname = 'areacello_Ofx_BCC-CSM2-MR_hist-resIPO_r1i1p1f1_gn.nc';
fout  = [mdl_name,'_sections.mat'];
ncdisp([dname,fname]);
dmask = '/media/swang/CMIP6_1/BCC-CSM2-MR/';
fmask = 'so_Omon_BCC-CSM2-MR_ssp585_r1i1p1f1_gn_209501-210012_2100.nc';
ncdisp([dmask,fmask]);
