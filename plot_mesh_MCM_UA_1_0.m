...
ncdisp([dname,fname]);
dmask = '/media/swang/CMIP6_5/MCM-UA-1-0/';
fmask = 'so_Omon_MCM-UA-1-0_ssp585_r1i1p1f2_gn_201501-210012_2100.nc';
ncdisp([dmask,fmask]);
...
figure;
m_proj('Azimuthal Equal-area','lon',0,'lat',90,'radius',30);
